...
export function Providers() {
  ...
  const handleProviderChange = (_index: number, field: string, value: string | any[] | any) => {
            ...
            <div className="space-y-4 p-4 overflow-y-auto flex-grow">
              ...
              <div className="space-y-2">
                <AccountManager
                  ...
                  onChange={(accounts) => handleProviderChange(editingProviderIndex, 'accounts', accounts)}
                  legacyApiKey={editingProvider.api_key || ''}
                  onLegacyApiKeyChange={(key) => handleProviderChange(editingProviderIndex, 'api_key', key)}
                />
              </div>
              <div className="space-y-2">
